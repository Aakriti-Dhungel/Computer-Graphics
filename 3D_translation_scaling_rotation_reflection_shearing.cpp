...
//initwindow(500,500,"3D transformation");
    ...
    switch(choice) {
        ...
        case 4: {
    		...
    		// Adjust the x-coordinates if they go outside the screen
    		if (x1 < 0) {
        		x1 = screenWidth + x1;  // Move the bar into view by shifting it
    		}
    		if (x2 < 0) {
        		x2 = screenWidth + x2;  // Similarly adjust the other end of the bar
    		}
